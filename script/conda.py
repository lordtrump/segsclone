...
scripts = [
    f"curl -sLo {pantat} https://github.com/lordtrump/segsclone/raw/main/script/pantat88.py",
    f"curl -sLo {css} https://github.com/lordtrump/segsclone/raw/main/script/pantat88.css",
    f"curl -sLo {nenen} https://github.com/lordtrump/segsclone/raw/main/script/nenen88.py",
    f"curl -sLo {startup}/00-startup.py https://github.com/lordtrump/segsclone/raw/main/script/00-startup.py",
    f"curl -sLo {startup}/util.py https://github.com/lordtrump/segsclone/raw/main/script/util.py",
    f"curl -sLo {img} https://github.com/lordtrump/segsclone/raw/main/script/loading.png",
    f"curl -sLo {startup}/cupang.py https://github.com/lordtrump/segsclone/raw/main/script/cupang.py"
]
