...
def webui_req():
    ...
    scripts = [
        f"https://github.com/lordtrump/segsclone/raw/main/script/controlnet/controlnet.py {WEBUI}/asd",
        f"https://github.com/lordtrump/segsclone/raw/main/script/zrok.py {WEBUI}",
...
def sd_15():
    ...
    extras = [
        f"https://huggingface.co/godtrex99/PVTFiles/resolve/main/ETC/startpack.zip {WEBUI}",
