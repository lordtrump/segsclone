...
img = Path.home() / ".lordtrump/loading.png"
...
def controlnet_widgets():
    x = [
        f"curl -sLo {cn15} https://github.com/lordtrump/segsclone/raw/main/script/controlnet/cn-15.py",
        f"curl -sLo {cnxl} https://github.com/lordtrump/segsclone/raw/main/script/controlnet/cn-xl.py",
        f"curl -sLo {css_cn} https://github.com/lordtrump/segsclone/raw/main/script/controlnet/cn.css"]
    for y in x:
